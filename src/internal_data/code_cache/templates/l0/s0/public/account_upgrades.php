<?php
// FROM HASH: a3a981edf805e7950e6d78a1b6975b29
return array(
						...
						foreach ($__vars['upgrade']['payment_profile_ids'] AS $__vars['profileId']) {
							if ($__vars['profiles'][$__vars['profileId']]) {
								$__compilerTemp3[] = array(
									...
									'label' => ($__templater->escape($__vars['profiles'][$__vars['profileId']]['display_title']) ?: $__templater->escape($__vars['profiles'][$__vars['profileId']]['title'])),
									'_type' => 'option',
								);
							}
						}
