<?php
// FROM HASH: 74a80d9d70b5c7ef012b32b7edde2803
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__compilerTemp1) {
		$__finalCompiled .= '
			<div class="block-row">' . 'There are no visible reactions on this page.' . '</div>
		';
	}
	$__finalCompiled .= '
		';
...
';
	if ((($__templater->func('count', array($__vars['reactions'], ), false) > 0) OR ($__vars['page'] > 1)) OR $__vars['hasNext']) {
		$__finalCompiled .= '
	';
		if (!$__vars['listOnly']) {
			$__finalCompiled .= '
