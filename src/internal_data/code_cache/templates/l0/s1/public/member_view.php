<?php
// FROM HASH: d81b7e5c94f752002b114332920d7737
return array(
...
';
	...
	<script type="application/ld+json">
		' . $__templater->filter($__templater->method($__vars['user'], 'getLdStructuredData', array(array('followers_count' => $__vars['followersCount'], ), )), array(array('json', array(true, )),array('raw', array()),), true) . '
	</script>
');
	$__finalCompiled .= '
